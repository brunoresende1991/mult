...
def get_translations():
    ...
    if filename:
        ctx.flask_user_translations = support.Translations.load(
            app_dir, locales, domain=domain)
    ...
    # See if translations exists in Flask-User dir
        ...
        ctx.flask_user_translations = support.Translations.load(
            flask_user_dir, locales, domain=domain)
...
_ = lazy_gettext
_home_page = _('Home')
_profile_page = _('Pagina de Perfil')
_special_page = _('Pagina Especial')
